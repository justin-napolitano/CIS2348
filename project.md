...
slug: github-cis2348
id: github-cis2348
title: CIS2348 Python Assignments and Projects Repository
...
1. Clone the repository:
   ```bash
   git clone https://github.com/justin-napolitano/CIS2348.git
   cd CIS2348
   ```

### Running Code

- Navigate to the desired homework folder (e.g., `HW1`, `HW2`, etc.).
- Run Python scripts using the command:
  ```bash
  python filename.py
  ```
- Some scripts require input files (e.g., `inputDates.txt`, `ManufacturerList.csv`), ensure these files are present in the working directory.
